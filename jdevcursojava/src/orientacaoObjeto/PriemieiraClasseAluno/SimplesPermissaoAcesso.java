...
public class SimplesPermissaoAcesso {
	
	

		
			public static void main(String[] args) {
				String login  = JOptionPane.showInputDialog("Informe ao login:");
			...
			if(login.equalsIgnoreCase("admin") &&  senha.equalsIgnoreCase("admin")){
		    	...
		    	JOptionPane.showMessageDialog(null, "Login e senha não permitidos");
		    }
	    }
